...
#define CONFIG_ESP_SLEEP_SET_FLASH_DPD 1
#define CONFIG_ESP_SLEEP_SPI_FLASH_ENTER_DPD_MODE_DELAY 25
#define CONFIG_ESP_SLEEP_SPI_FLASH_EXIT_DPD_MODE_DELAY 40
